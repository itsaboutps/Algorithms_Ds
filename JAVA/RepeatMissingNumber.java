...
public class RepeatMissingNumber {
    public static void main(String[] args) {
        ...
        // reapeatMissingNumber(arr);
        reapeatMissingNumbers(arr);
    }

    private static void reapeatMissingNumbers(int[] arr) {
    ...
    private static void reapeatMissingNumber(int[] arr) {
